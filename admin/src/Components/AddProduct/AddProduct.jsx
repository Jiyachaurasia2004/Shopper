...
const AddProduct = () => {
  ...
  const Add_Product = async () => {
    ...
    try {
      ...
      const uploadResp = await fetch('https://shopper-backend-37ge.onrender.com/upload', {
        method: 'POST',
        body: formData
      });
      ...
      const addResp = await fetch('https://shopper-backend-37ge.onrender.com/addproduct', {
        method: 'POST',
