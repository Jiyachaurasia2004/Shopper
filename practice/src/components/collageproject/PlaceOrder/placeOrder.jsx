...
function PlaceOrder() {
  ...
  const handlePlaceOrder = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post("https://shopper-e-commerce-backend-gip0.onrender.com/api/payment/create-order", {
        amount: orderTotal,
        items,
        address: form
      }, {
      ...
      // Fetch Razorpay Key
      const { data: { key } } = await axios.get("https://shopper-e-commerce-backend-gip0.onrender.com/api/payment/get-key");
      ...
      if (data.success) {
        ...
        const options = {
          ...
          handler: async function (response) {
            // 3. Verify Payment
            try {
              const verifyRes = await axios.post("https://shopper-e-commerce-backend-gip0.onrender.com/api/payment/verify-payment", {
