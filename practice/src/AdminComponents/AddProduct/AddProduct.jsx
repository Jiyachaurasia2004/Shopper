...
import upload_area from '../../AdminAssets/upload_area.svg';
...
const AddProduct = () => {
  ...
  const Add_Product = async () => {
    ...
    try {
      ...
      const uploadResp = await fetch('https://shopper-e-commerce-backend-gip0.onrender.com/upload', {
        method: 'POST',
        body: formData
      });
      ...
      const addResp = await fetch('https://shopper-e-commerce-backend-gip0.onrender.com/addproduct', {
        method: 'POST',
