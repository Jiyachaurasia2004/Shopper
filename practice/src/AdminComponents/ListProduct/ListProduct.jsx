...
const ListProduct = () => {
  ...
  const fetchProducts = async () => {
    setLoading(true);
    try {
      const res = await fetch('https://shopper-e-commerce-backend-gip0.onrender.com/allproducts');
  ...
  const removeProduct = async (id) => {
    ...
    try {
      const res = await fetch('https://shopper-e-commerce-backend-gip0.onrender.com/removeproduct', {
        method: 'POST',
